    ...
    if(isset($_POST['func'])){
        ...
        switch($func){
            ...
            case 'credits':
                ...
                $text .= '<p><span class=\"credit-category\">'._('Newest Developers').'</span><br/><span class=\"credit-sole\"><a href=\"http://hackanoob.com/aboutus\">HackanooB Dev Squad</a></span></p>';
                ...
                $text .= '<br/><span class=\"small\">'._('You should be here?').' <a class=\"black\" href=\"mailto:'._('contact@hackanoob.net').'\">'._('Contact us').'</a>!</span>';
