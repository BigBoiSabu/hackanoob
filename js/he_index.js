...
$(document).ready(function(){
	...
	$('#terminal').typist({
	  ...
	  function typeconsole (){
        ...
        .typist('promptecho')
        .typist('wait', '1000')
        .typist('print', 'Hacker@hax:-$')
        .typist('wait', '400')
        .typist('promptecho')
        .typist('type', 'ssh microsoft.com')
        .typist('wait', '400')
        ...
        .typist('wait', '400')
        .typist('promptecho')
        .typist('type', 'ssh slavehack2.com')
        .typist('wait', '400')
        .typist('print', 'Enter username:')
        .typist('promptecho')
        .typist('wait', '200')
        .typist('type', 'MrBurnZZ')
        .typist('wait', '500')
        .typist('print', 'Enter password:')
        .typist('promptecho')
        .typist('wait', '200')
        ...
        .typist('promptecho')
        .typist('wait', '200')
        .typist('print', 'Access Granted!')
        .typist('wait', '1000')
        .typist('promptecho')
        .typist('print', 'root@MrBurnZZ:-#')
        .typist('promptecho')
        .typist('wait', '600')
        .typist('type', 'ls')
        .typist('wait', '1000')
        ...
        .typist('promptecho')
        .typist('wait', '600')
        .typist('type', 'dl MrBurnZZs nudes')
        .typist('wait', '1000')
        .typist('promptecho')
        .typist('wait', '600')
        .typist('print', 'Downloading MrBurnZZs nudes')
        .typist('wait', '800')
        .typist('promptecho')
        .typist('wait', '600')
        .typist('print', 'root@MrBurnZZ:-#')
        ...
        .typist('promptecho')
        .typist('wait', '600')
        .typist('type', 'rm MrBurnZZs nudes')
        .typist('wait', '1000')
        .typist('promptecho')
        .typist('wait', '600')
        .typist('print', 'Removing MrBurnZZs nudes')
        .typist('wait', '800')
        .typist('promptecho')
        .typist('wait', '600')
        .typist('print', 'root@MrBurnZZ:-#')
