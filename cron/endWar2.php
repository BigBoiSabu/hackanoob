    ...
    for($i=0;$i<sizeof($warInfo);$i++){
        ...
        for($k = 0; $k < sizeof($usersInvolved); $k++){
            ...
            if(!array_key_exists($usersInvolved[$k]['attid'], $sentArr)){
                ...
                exec('/usr/bin/env python /home/elite/hackanoob/python/badge_add.py user '.$to.' 60'); // CHANGE TO ABSOLUTE GAME PATH
        ...
        exec('/usr/bin/env python /home/elite/hackanoob/python/badge_add.py user '.$mostInfluentID.' 61'); // CHANGE TO ABSOLUTE GAME PATH
        exec('/usr/bin/env python /home/elite/hackanoob/python/badge_add.py user '.$mostInfluentID.' 71'); // CHANGE TO ABSOLUTE GAME PATH
