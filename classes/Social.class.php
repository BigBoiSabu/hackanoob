...
class Social {
    ...
    public function profile_show($l){
        ...
        require 'public_html/profile/'.$this->profileID.'_'.$l.'.html';
...
<?php        
    ...
    public function friend_request($friendID){
        ...
        //} else {
            ...
            $text = 'Hey! '.$userInfo->login.' added you as a friend. If you don\'t know them, just ignore this email, otherwise... <br/><a href="profile?view=friends&request='.$requestID.'&opt=add&friend='.$_SESSION['id'].'">Accept request</a>';
        //}
