...
<br/>
<br/>
<?php echo _('If you prefer, you can mail us at'); ?> <code><?php echo _('contact@hackanoob.net'); ?></code>.<br/>
        ...
        <div class="span5">
            <div class="widget-box">
                ...
                <div class="widget-content center">
                    ...
                    <a href="https://wiki.hackanoob.net">https://wiki.hackanoob.net/</a>
                    <br/>
                    <br/>
                    <strong><?php echo _('Forum'); ?></strong><br/>
                    <a href="https://forum.hackanoob.net">https://forum.hackanoob.net/</a>
                </div>
            </div>
        </div>
    </div>
