...
?>
        ...
        <div id="breadcrumb" class="center">
            ...
            <span class="pull-left hide-phone"><a href="https://forum.hackanoob.net/" ><font color=""><?php echo _("Forum"); ?></font></a></span>
            <span class="pull-left hide-phone"><a href="stats" ><?php echo _("Stats"); ?></a></span>
            
            <span class="center">2013 ~ 2019 &copy; <b>HE Community</b><a href="https://status.hackanoob.net/"><?php echo $queries; ?> <?php echo _("queries in"); ?> <?php echo $time; ?> ms</a></span>
...
if(array_key_exists('BUFFER_QUERY', $_SESSION)){
    if($_SESSION['BUFFER_QUERY'] >= 500 || rand(1,20) == 1){
        exec('/usr/bin/env python /home/elite/hackanoob/python/query_counter.py '.$_SESSION['BUFFER_QUERY']); // CHANGE TO ABSOLUTE GAME PATH
