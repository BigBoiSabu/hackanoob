            ...
            <div class="container">
                <div class="row">
                    <div id="mAbout" class="col-lg-5 col-sm-6">
                        ...
                        <div class="clearfix"></div>
                        <h2 class="section-heading"><?php echo _('About HackanooB'); ?></h2>
                        <p class="lead">
                            <?php echo _('HackanooB is a browser-based hacking simulation game based on Hacker Experience legacy code, where you play the role of a hacker seeking money and power.'); ?>
                        </p>
                        <p class="lead">
                        ...
                        <p class="lead">
                            <?php echo sprintf(_('%sSign up now%s for free and join thousands of other players trying to be the most powerful hacker in the game.'), '<a class="goto-signup link">', '</a>'); ?>
                        </p>
                        ...
                        <form class="form-horizontal" id="signup-form" action="register.php" method="POST">
                            <fieldset class="signup">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <!-- changed id from password to newpassword (since there was another input using the same id -->
                                        <input id="newpassword" name="password" placeholder="123456" class="form-control input-md" type="password">
                                    </div>
                                </div>
                                <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div id="accordion">
                        ...
                        <div>
                            ...
                            <p><?php echo _('The only reason we can offer HackanooB for free is because of the non-intrusive ads we show in the game.'); ?></p>
                    ...
                    <div class="faq-buttons-intro">
                        <h3 class="text-center" style="margin-bottom: 20px;"><?php echo _('So, what are you waiting for?'); ?></h2>
                        <ul class="list-inline intro-social-buttons">
            ...
            <div class="row">
                ...
                <div id="legal-disclaimer" class="three columns">
                    ...
                    <p style="margin-top: -10px;">
                        <?php echo _('HackanooB is <strong>NOT</strong> related to any real hacking activity.'); ?>
                        <?php echo _('All in-game content is purely fictional and does not represent real user identification. IP addresses are randomly generated.'); ?>
                    </p>
                </div>
                <div id="contact" class="four columns text-right">
                    ...
                    <div class="footer-social">
                        <a href="https://facebook.com/HackanooB"><i class="fa fa-facebook-square"></i></a>
                        <a href="https://twitter.com/HackanooB"><i class="fa fa-twitter"></i></a>
                        <!--<a href="https://plus.google.com/105485198485447624885" rel="publisher"><i class="fa fa-google-plus"></i></a>-->
                        <a href="https://discord.gg/BMfDC9G"><i class="fa fa-discord"></i></a>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="three columns">
                    <span id="hand" class="footer-social left small" style="margin-left: 35%;"><?php echo _('Handcrafted by Hackers'); ?></span>
                </div>
                <h3 id="neoart" class="footer-title right">2020 - Present &copy; <a href="#" style="color: #fff; margin-right: 10px;">Based on Hacker Experience</a></h3>
